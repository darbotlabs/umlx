...
def tree_map(
    ...
    .. code-block:: python
        ...
        from umlx.utils import tree_map
...
def tree_map_with_path(
    ...
    *rest: Any,
    ...
    Example:
        >>> from umlx.utils import tree_map_with_path
...
def tree_flatten(
    ...
    .. code-block:: python
        ...
        from umlx.utils import tree_flatten
...
def tree_unflatten(tree: Union[List[Tuple[str, Any]], Dict[str, Any]]) -> Any:
    ...
    .. code-block:: python
        ...
        from umlx.utils import tree_unflatten
...
def tree_reduce(fn, tree, initializer=None, is_leaf=None):
    ...
    Example:
        >>> from umlx.utils import tree_reduce
        >>> tree = {"a": [1, 2, 3], "b": [4, 5]}
