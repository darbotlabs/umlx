...
import umlx_tests
from umlx.nn.layers.distributed import shard_inplace, shard_linear
from umlx.nn.utils import average_gradients


class MLXDistributedCommonTestCase(umlx_tests.UMLXTestCase):
