...
#include "umlx/backend/metal/kernels/fp4.h"
#include "umlx/backend/metal/kernels/fp8.h"
...
METAL_FUNC void fp_qmm_t_impl(
  ...
  using mma_t = umlx::steel::
      BlockMMA<T, T, BM, BN, BK, WM, WN, false, true, BK_padded, BK_padded>;
  using loader_x_t =
      umlx::steel::BlockLoader<T, BM, BK, BK_padded, 1, WM * WN * SIMD_SIZE>;
...
[[kernel]] void fp_gather_qmm_rhs(
  ...
  using mma_t = umlx::steel::BlockMMA<
      T,
      T,
      BM,
      BN,
